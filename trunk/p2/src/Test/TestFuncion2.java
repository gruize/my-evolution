...
public class TestFuncion2 {
	...
	public static void main(String[] args) {
		AlgoritmoGenetico algGen = new AlgoritmoGenetico(4, 4, 0.7, 0.3, 0.5, Funciones.Funcion2, Selecciones.Ruleta, 0, false, 0);
		algGen.inicializa();
		...
		System.out.print("Genes\tFenotipoX\t\tFenotipoY\t\tAptitud\t\t\tPuntuacion\t\tPuntuacionAcumulada\n");
		for(int i = 0; i < tam; i++){			
			String cromo = "";
