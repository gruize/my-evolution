...
public class ConfigPanel<T> extends JPanel {
	...
	public static class CheckOption<T> extends SimpleOption<T>{

		boolean check;
		
		public CheckOption(String label, String tooltip, String fieldName) {
			super(label, tooltip,fieldName);
		}
		...
		@Override
		protected void writeControl(Object v) {
			((JCheckBox)control).setSelected((Boolean) v);
		}
